...
| Database & function tests | 109 | ~29,300 |
...
| **Total hand-written** | **665** | **~168,600** |
...
drift checks, 4,367 tests, production build —
...
Database    1,933 tests   against real PostgreSQL 18 (PGlite)
