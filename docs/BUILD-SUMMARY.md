...
| Database migrations (54 files, 137 tables, 13 views) | 54 | ~12,500 |
| Edge Functions + shared modules | 28 | ~4,500 |
| Database & function tests | 41 | ~10,800 |
...
drift checks, 1,932 tests, production build —
