...
| Database migrations (85 files, 155 tables, 47 views) | 85 | ~20,900 |
| Edge Functions + shared modules | 55 | ~8,500 |
| Database & function tests | 67 | ~16,700 |
| Governance & traceability tests | 6 | ~2,800 |
| Web application (46 routes, 24 app screens) | 128 | ~27,000 |
| Documentation | 14 | ~4,900 |
| Seed & tooling | 8 | ~1,900 |
| **Total hand-written** | **414** | **~97,500** |
...
drift checks, 2,566 tests, production build —
...
Database    1,123 tests   against real PostgreSQL 18 (PGlite)
