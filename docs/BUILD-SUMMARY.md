...
| Database migrations (45 files, 136 tables, 12 views) | 45 | ~11,200 |
| Edge Functions + shared modules | 28 | ~4,500 |
| Database & function tests | 33 | ~9,300 |
...
drift checks, 1,832 tests, production build —
...
Database      638 tests   against real PostgreSQL 18 (PGlite)
