...
| Database migrations (154 files, 168 tables, 88 views) | 154 | ~38,000 |
| Edge Functions + shared modules | 60 | ~9,600 |
| Database & function tests | 117 | ~31,300 |
| Governance & traceability tests | 15 | ~3,800 |
| Web application (49 routes, 29 app screens) | 265 | ~68,000 |
| Documentation | 16 | ~5,900 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **697** | **~176,600** |
...
drift checks, 4,589 tests, production build —
...
Database    2,060 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,200 tests   jsdom + Testing Library
            ───────────
            4,589 tests
```
