...
| Database migrations (147 files, 168 tables, 87 views) | 147 | ~36,800 |
...
drift checks, 4,436 tests, production build —
...
Database    1,965 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,142 tests   jsdom + Testing Library
            ───────────
            4,436 tests
```
