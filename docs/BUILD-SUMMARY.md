...
| Database migrations (162 files, 168 tables, 91 views) | 162 | ~40,300 |
| Edge Functions + shared modules | 61 | ~10,000 |
| Database & function tests | 123 | ~32,800 |
| Governance & traceability tests | 15 | ~3,800 |
| Web application (49 routes, 29 app screens) | 286 | ~75,300 |
| Documentation | 16 | ~6,000 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **733** | **~188,000** |
...
drift checks, 4,769 tests, production build —
...
Database    2,160 tests   against real PostgreSQL 18 (PGlite)
Functions     284 tests   billing, plan versioning, AI governance, API, observability
Governance    298 tests   the five-category rule, traceability, verification, spelling, pipeline
Web         1,269 tests   jsdom + Testing Library
            ───────────
            4,769 tests
```
