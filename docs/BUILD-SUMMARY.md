...
| Database migrations (149 files, 168 tables, 88 views) | 149 | ~37,500 |
| Edge Functions + shared modules | 60 | ~9,600 |
| Database & function tests | 114 | ~30,700 |
| Governance & traceability tests | 15 | ~3,800 |
| Web application (49 routes, 29 app screens) | 263 | ~66,900 |
| Documentation | 16 | ~5,900 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **687** | **~174,400** |
...
drift checks, 4,523 tests, production build —
...
Database    2,023 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,171 tests   jsdom + Testing Library
            ───────────
            4,523 tests
```
