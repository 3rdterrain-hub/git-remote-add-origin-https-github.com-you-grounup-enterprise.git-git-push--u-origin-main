...
| Database migrations (48 files, 136 tables, 12 views) | 48 | ~12,000 |
| Edge Functions + shared modules | 28 | ~4,500 |
| Database & function tests | 36 | ~10,000 |
...
drift checks, 1,882 tests, production build —
...
Database      684 tests   against real PostgreSQL 18 (PGlite)
