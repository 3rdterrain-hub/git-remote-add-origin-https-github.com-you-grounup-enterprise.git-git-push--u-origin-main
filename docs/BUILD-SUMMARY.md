...
| Database migrations (234 files, 177 tables, 146 views) | 234 | ~65,200 |
...
drift checks, 5,648 tests, production build —
...
Database    2,719 tests   against real PostgreSQL 18 (PGlite)
