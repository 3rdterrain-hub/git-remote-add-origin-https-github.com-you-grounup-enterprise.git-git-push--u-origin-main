...
| Database migrations (177 files, 172 tables, 102 views) | 177 | ~48,500 |
| Edge Functions + shared modules | 61 | ~10,000 |
| Database & function tests | 136 | ~35,300 |
| Governance & traceability tests | 16 | ~4,000 |
| Web application (50 routes, 29 app screens) | 328 | ~83,700 |
| Documentation | 16 | ~6,000 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **804** | **~207,400** |
...
drift checks, 5,047 tests, production build —
...
Database    2,292 tests   against real PostgreSQL 18 (PGlite)
