...
| Database migrations (207 files, 173 tables, 132 views) | 207 | ~60,000 |
| Edge Functions + shared modules | 66 | ~10,700 |
| Database & function tests | 154 | ~39,600 |
| Governance & traceability tests | 19 | ~4,400 |
| Web application (50 routes, 29 app screens) | 372 | ~97,500 |
| Documentation | 16 | ~6,100 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **904** | **~238,400** |
...
drift checks, 5,386 tests, production build —
...
Database    2,558 tests   against real PostgreSQL 18 (PGlite)
