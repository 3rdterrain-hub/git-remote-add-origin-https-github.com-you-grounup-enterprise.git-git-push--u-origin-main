...
| Web application (30 routes, 23 app screens) | 86 | ~14,500 |
| Documentation | 13 | ~4,400 |
| Seed & tooling | 7 | ~1,800 |
| **Total hand-written** | **285** | **~64,600** |
...
drift checks, 1,977 tests, production build —
...
Web           172 tests   jsdom + Testing Library
            ───────────
            1,977 tests
```
