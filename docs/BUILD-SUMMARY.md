...
| Database migrations (167 files, 171 tables, 93 views) | 167 | ~45,500 |
| Edge Functions + shared modules | 61 | ~10,000 |
| Database & function tests | 127 | ~33,500 |
| Governance & traceability tests | 15 | ~3,800 |
| Web application (50 routes, 29 app screens) | 296 | ~77,000 |
| Documentation | 16 | ~6,000 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **752** | **~195,700** |
...
drift checks, 4,822 tests, production build —
...
Database    2,198 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,284 tests   jsdom + Testing Library
            ───────────
            4,822 tests
```
