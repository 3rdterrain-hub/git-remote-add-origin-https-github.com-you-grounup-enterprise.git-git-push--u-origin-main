...
| Database migrations (214 files, 173 tables, 140 views) | 214 | ~61,700 |
| Edge Functions + shared modules | 66 | ~10,800 |
| Database & function tests | 158 | ~40,500 |
| Governance & traceability tests | 20 | ~4,400 |
| Web application (51 routes, 29 app screens) | 385 | ~100,700 |
| Documentation | 16 | ~6,200 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **929** | **~244,500** |
...
drift checks, 5,508 tests, production build —
...
Database    2,618 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,508 tests   jsdom + Testing Library
            ───────────
            5,508 tests
```
