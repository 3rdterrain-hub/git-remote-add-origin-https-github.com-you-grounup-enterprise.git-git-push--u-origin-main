...
| Database migrations (53 files, 136 tables, 13 views) | 53 | ~12,400 |
| Edge Functions + shared modules | 28 | ~4,500 |
| Database & function tests | 40 | ~10,700 |
...
drift checks, 1,922 tests, production build —
...
Database      720 tests   against real PostgreSQL 18 (PGlite)
