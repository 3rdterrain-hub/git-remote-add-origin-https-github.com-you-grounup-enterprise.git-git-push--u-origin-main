...
| Database migrations (49 files, 136 tables, 12 views) | 49 | ~12,000 |
| Edge Functions + shared modules | 28 | ~4,500 |
| Database & function tests | 37 | ~10,100 |
...
drift checks, 1,888 tests, production build —
...
Database      690 tests   against real PostgreSQL 18 (PGlite)
