...
| Database migrations (153 files, 168 tables, 88 views) | 153 | ~38,000 |
| Edge Functions + shared modules | 60 | ~9,600 |
| Database & function tests | 116 | ~31,200 |
| Governance & traceability tests | 15 | ~3,800 |
| Web application (49 routes, 29 app screens) | 263 | ~67,300 |
| Documentation | 16 | ~5,900 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **693** | **~175,700** |
...
drift checks, 4,557 tests, production build —
...
Database    2,046 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,182 tests   jsdom + Testing Library
            ───────────
            4,557 tests
```
