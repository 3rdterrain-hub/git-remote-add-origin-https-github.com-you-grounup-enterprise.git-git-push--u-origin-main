...
| Database migrations (171 files, 171 tables, 96 views) | 171 | ~46,400 |
| Edge Functions + shared modules | 61 | ~10,000 |
| Database & function tests | 130 | ~34,000 |
| Governance & traceability tests | 16 | ~4,000 |
| Web application (50 routes, 29 app screens) | 312 | ~80,200 |
| Documentation | 16 | ~6,000 |
| Seed & tooling | 12 | ~3,200 |
| **Total hand-written** | **776** | **~200,500** |
...
drift checks, 4,916 tests, production build —
...
Database    2,224 tests   against real PostgreSQL 18 (PGlite)
...
Web         1,349 tests   jsdom + Testing Library
            ───────────
            4,916 tests
```
