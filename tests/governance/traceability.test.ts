...
describe('tracing is not verification, and the matrix must not blur them', () => {
  ...
  it('reports verification only where a ledger judged it', () => {
    // Twenty-eight phases have been judged requirement by requirement; nothing else
    ...
    expect(new Set(judged.map((r) => r.phase))).toEqual(new Set(['P01', 'P02', 'P03', 'P04', 'P05', 'P06', 'P07', 'P08', 'P09', 'P10', 'P11', 'P12', 'P13', 'P14', 'P15', 'P16', 'P17', 'P18', 'P19', 'P20', 'P23', 'P24', 'P25', 'P26', 'P27', 'P28', 'P29', 'P30']));
    expect(judged).toHaveLength(25 + 60 + 75 + 97 + 108 + 120 + 300 + 300 + 160 + 180 + 210 + 240 + 360 + 380 + 260 + 280 + 320 + 340 + 400 + 420 + 450 + 360 + 400 + 450 + 480 + 500 + 520 + 540);
