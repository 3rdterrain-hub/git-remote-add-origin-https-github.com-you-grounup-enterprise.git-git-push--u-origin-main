...
| **Database** | `supabase/migrations` | 130 migrations, 167 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
