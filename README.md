...
| **Database** | `supabase/migrations` | 171 migrations, 171 tables, 20 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
