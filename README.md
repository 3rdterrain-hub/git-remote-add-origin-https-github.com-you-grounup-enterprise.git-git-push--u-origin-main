...
| **Database** | `supabase/migrations` | 111 migrations, 163 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
