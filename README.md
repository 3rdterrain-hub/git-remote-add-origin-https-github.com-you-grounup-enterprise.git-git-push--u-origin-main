...
| **Database** | `supabase/migrations` | 42 migrations, 136 tables, 9 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
