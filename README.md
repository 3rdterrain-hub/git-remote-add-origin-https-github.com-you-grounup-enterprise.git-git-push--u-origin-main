...
| **Database** | `supabase/migrations` | 67 migrations, 142 tables, 17 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
