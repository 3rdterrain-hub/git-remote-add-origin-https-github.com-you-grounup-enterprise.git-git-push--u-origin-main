...
| **Database** | `supabase/migrations` | 105 migrations, 162 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
