...
| **Database** | `supabase/migrations` | 95 migrations, 161 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
