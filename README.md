...
| **Database** | `supabase/migrations` | 218 migrations, 174 tables, 20 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
