...
| **Database** | `supabase/migrations` | 50 migrations, 136 tables, 11 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
