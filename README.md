...
| **Database** | `supabase/migrations` | 51 migrations, 136 tables, 12 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
