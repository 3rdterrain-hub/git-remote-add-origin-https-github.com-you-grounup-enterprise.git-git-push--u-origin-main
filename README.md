...
| **Database** | `supabase/migrations` | 96 migrations, 161 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
