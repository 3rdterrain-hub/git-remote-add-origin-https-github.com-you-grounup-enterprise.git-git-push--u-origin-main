...
| **Database** | `supabase/migrations` | 133 migrations, 167 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
