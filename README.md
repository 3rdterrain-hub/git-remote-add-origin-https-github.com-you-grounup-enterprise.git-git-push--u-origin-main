...
| **Database** | `supabase/migrations` | 56 migrations, 137 tables, 12 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
