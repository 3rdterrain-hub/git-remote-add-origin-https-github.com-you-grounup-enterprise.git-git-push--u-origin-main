...
| **Database** | `supabase/migrations` | 65 migrations, 142 tables, 16 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
