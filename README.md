...
| **Database** | `supabase/migrations` | 60 migrations, 137 tables, 15 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
