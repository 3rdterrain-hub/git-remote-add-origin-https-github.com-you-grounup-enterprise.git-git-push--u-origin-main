...
| **Database** | `supabase/migrations` | 68 migrations, 143 tables, 17 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
