...
| **Database** | `supabase/migrations` | 214 migrations, 173 tables, 20 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
