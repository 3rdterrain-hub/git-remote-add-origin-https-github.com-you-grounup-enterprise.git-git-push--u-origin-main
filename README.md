...
| **Database** | `supabase/migrations` | 115 migrations, 165 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
