...
| **Database** | `supabase/migrations` | 86 migrations, 155 tables, 19 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
