...
| **Database** | `supabase/migrations` | 70 migrations, 143 tables, 18 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
