...
| **Database** | `supabase/migrations` | 142 migrations, 168 tables, 20 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
