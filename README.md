...
| **Database** | `supabase/migrations` | 62 migrations, 139 tables, 16 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
