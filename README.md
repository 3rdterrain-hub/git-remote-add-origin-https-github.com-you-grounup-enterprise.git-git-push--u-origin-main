...
| **Database** | `supabase/migrations` | 52 migrations, 136 tables, 12 reporting views: multi-tenant schema, RLS forced on every table, audit ledger, governance triggers. |
