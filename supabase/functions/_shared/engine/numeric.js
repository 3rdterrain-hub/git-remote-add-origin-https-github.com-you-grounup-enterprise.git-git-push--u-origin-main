 ...
 */
export const money = (v) => roundTo(roundTo(v, SCALE.MONEY + 4), SCALE.MONEY);
/** Round to unit-rate precision. */
export const unitRate = (v) => roundTo(v, SCALE.UNIT_RATE);
/** Round to quantity precision. */
export const qty = (v) => roundTo(v, SCALE.QUANTITY);
/** Round to hour precision. */
export const hours = (v) => roundTo(v, SCALE.HOURS);
/** Round to factor precision. */
export const factor = (v) => roundTo(v, SCALE.FACTOR);
...
export function assertFinite(value, field) {
